 ...
 */
	function label($fieldName = null, $text = null, $options = array('class'=>'control-label')) {
		if (empty($fieldName)) {
			$view = ClassRegistry::getObject('view');
 ...
 */
	function checkbox($fieldName, $options = array()) {
		...
		{
				return sprintf(
				$this->Html->div('controls',$this->Html->tags['checkbox'].$this->Html->tag('span',$options['help-block'],array('class'=>'help-block'))),
				$options['name'],
				$this->_parseAttributes($options, array('name'), null, ' ')
			);
		}
		...
		return $output . sprintf(
			$this->Html->div('control-group',$this->label('').$this->Html->div('controls',$this->label('',$this->Html->tags['checkbox'],array('class'=>'checkbox')))),
			$options['name'],
			$this->_parseAttributes($options, array('name'), null, ' ')
		);
	}
